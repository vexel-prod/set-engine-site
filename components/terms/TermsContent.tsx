    ...
    <div className='max-w-4xl mx-auto py-12 space-y-16 text-left'>
      <header className='space-y-4 border-b border-zinc-200 dark:border-zinc-800 pb-12'>
        <h1 className='text-5xl font-display font-bold uppercase tracking-tighter'>
          Обработка <br />
          <span className='text-zinc-400'>Заявок</span>
        </h1>
      ...
      <div className='space-y-12'>
            ...
            {[
              {
                time: '0-15 мин',
                label: 'Регистрация',
                desc: 'Автоматическое присвоение ID и уведомление ответственного инженера.',
              },
              {
                time: '1-3 часа',
                label: 'Первичный скоринг',
                desc: 'Анализ задачи на предмет технической возможности реализации.',
              },
              {
                time: 'До 24 ч',
                label: 'Feedback',
                desc: 'Прямой контакт специалиста для уточнения деталей ТЗ.',
              },
            ].map((step, i) => (
              <div
                key={i}
                className='flex items-center gap-6 p-6 bg-zinc-50 dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800'
              >
                <div className='text-center min-w-20'>
                  <div className='text-brand-500 font-bold font-mono text-xs uppercase'>
                    {step.time}
                  </div>
                </div>
        ...
        <section className='space-y-6 text-left'>
          ...
          <div className='p-10 border border-zinc-200 dark:border-zinc-800 rounded-[40px] space-y-6 text-zinc-500 text-sm leading-relaxed'>
            ...
            <p>
              Ваши данные используются исключительно для подготовки КП, проведения расчетов и связи
              по техническим деталям.
            </p>
            <p className='font-bold text-zinc-900 dark:text-zinc-100'>
              Срок действия согласия: бессрочно или до момента получения письменного отзыва на
              почту.
            </p>
          </div>
        </section>
        ...
        <div className='flex flex-col sm:flex-row gap-6'>
          <div className='flex-1 p-8 bg-brand-500/5 border border-brand-500/20 rounded-3xl'>
            ...
            <p className='text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed'>
              Мы гарантируем ответ на 95% заявок в течение рабочего дня. Если вы не получили ответ —
              ваша заявка находится в глубоком техническом анализе.
            </p>
          </div>
          <div className='flex-1 p-8 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl'>
            ...
            <p className='text-xs text-zinc-500 leading-relaxed'>
              Данные хранятся в защищенной CRM-системе на серверах, расположенных на территории РФ.
            </p>
          </div>
        </div>
      </div>
